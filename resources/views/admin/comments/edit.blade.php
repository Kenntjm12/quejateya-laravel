...
<div class="row">
  <div class="col-md-6">
    <label for="description" class="coontrol-label">Descripcion <span class="text-danger">*</span></label>
    <input type="text" name="description" id="description" value="{{$comment->description}}" class="form-control" placeholder="Introduzca una descripcion" required>
  </div>
</div>
